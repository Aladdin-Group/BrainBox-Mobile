...
class GetWordsEvent extends EducationEvent {
  ...
  GetWordsEvent(
      {required this.essential, required this.unit, required this.onFail, required this.onSuccess, this.onProgress});
}
...
class ShowTranslationsEvent extends EducationEvent {}

class ChangeWordFontSize extends EducationEvent {
  final double fontSize;

  ChangeWordFontSize(this.fontSize);
}
